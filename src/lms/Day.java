...
public class Day
{
    ...
    /**
     Constructs a day using today's date.
     */
    public Day() {
        Calendar day = Calendar.getInstance();  // use today's date
        year = day.get(Calendar.YEAR);
        month = day.get(Calendar.MONTH)+1; // Calendar months start at 0
        date = day.get(Calendar.DATE);
    }
    
    /**
     Constructs a day from another Day (copy constructor)
     @param src the Day to copy
     */
    public Day (Day src) {
        year = src.year;
        month = src.month;
    ...
    /**
     sets the year of this day
     @param aYear the new year value
     */
    ...
    /**
     sets the month of this day
     @param aMonth the new month value
     */
    ...
    /**
     ...
     @param aDate the new date value
     */
